...
import Like_modal from './../LIKE/LIKE_FlatListItem/Like_Modal';
...
/**
       <View style={{ flex: 1, flexDirection: 'column' }}>
        ...
        >
          <Image
            source={{ uri: item.image }}
            style={{ width: 70, height: height_list, margin: 5 }}
          />
          <View
            style={{ flex: 1, height: height_list, flexDirection: 'column' }}
          >
            <Text style={styles.textBox}>item 項目</Text>
            <Text style={styles.textBox}>{item.introduction}</Text>
